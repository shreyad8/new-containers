...
structures. It is crucial to get these implemented correctly in order to be
...
class Node():
    ...
    interpreter. This is a key method to perform debugging,
...
class BinaryTree():
    ...
    def to_list(self, traversal_type):
        ...
        results rather than print them whenever possible.
        ...
        if traversal_type == 'preorder':
            ...
            raise ValueError('traversal_type=' + str(traversal_type)
                             + ' is not supported.')
